    ...
    <div class="container">
        <div class="flex flex-wrap">
            <div class="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
                <h2 class="font-bold text-4xl text-white mb-5">Politeknik Negeri Jember</h2>
            ...
            <div class="w-full px-4 mb-12 md:w-1/3">
                <h3 class="font-semibold text-xl text-white mb-5">Ketegori Tulisan</h3>
                <ul class="text-slate-300">
                    ...
                    <li>
                        <a href="#" class="inline-block text-base hover:text-primary mb-3">Development</a>
                    </li>
                </ul>
            </div>
            <div class="w-full px-4 mb-12 md:w-1/3">
        ...
        <div class="w-full pt-10 border-t border-slate-700">
            ...
            <p class="font-medium text-xs text-slate-500 text-center">Dibuat oleh kami, menggunakan <a href="https://tailwindcss.com" target="_blank" class="font-bold text-sky-500">Tailwind CSS</a>.</p>
        </div>
    </div>
</footer>
<!-- Footer Section End -->
