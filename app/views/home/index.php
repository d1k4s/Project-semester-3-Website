    ...
    <div class="container">
        <div class="flex flex-wrap">
            <div class="w-full self-center px-4">
                <h1 class="text-base font-semibold text-primary md:text-xl">Halo Gaess</h1>
                <h2 class="font-medium text-secondary text-lg mb-5 lg:text-2xl">Let's use our app</h2>
                <p class="font-medium text-secondary mb-10 leading-relaxed">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Odio, vitae!</p>

                <a href="#" class="text-base font-semibold text-white bg-primary py-3 px-8 rounded-md hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out">Download</a>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="flex flex-wrap">
            <div class="w-full px-4 mb-10 lg:w-1/2">
                ...
                <h2 class="font-bold text-dark text-3xl mb-5 max-w-md lg:text-4xl">Let's join us!</h2>
                <p class="font-medium text-base text-secondary max-w-xl lg:text-lg">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ex architecto consectetur odio, non laborum accusantium sapiente.</p>
            </div>
            <div class="w-full px-4 lg:w-1/2">
                <h3 class="font-semibold text-dark text-2xl mb-4 lg:text-3xl lg:pt-10">Mari Berteman</h3>
                <p class="font-medium text-base text-secondary mb-6 lg:text-lg">Lorem, ipsum dolor sit amet consectetur adipisicing elit. A autem ducimus non, molestiae dignissimos eveniet minus libero! Provident.</p>
                <div class="flex items-center">
                    <!-- Youtube -->
                    <a href="#" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white transition duration-300 ease-in-out">
    ...
    <div class="container">
        ...
        <div class="w-full px-4 flex flex-wrap justify-center xl:w-10/12 xl:mx-auto">
            <div class="mb-12 p-4 md:w-1/2">
                ...
                <h3 class="font-semibold text-dark text-xl mt-5 mb-3">Storitour Landing Page</h3>
                <p class="font-medium text-base text-secondary">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ipsum sit ex minus!</p>
            </div>
            <div class="mb-12 p-4 md:w-1/2">
                <div class="rounded-md shadow-md overflow-hidden">
                    <img src="<?= BASEURL; ?>/img/foto.jpg" alt="foto" width="w-full">
...
<section id="contact" class="pt-36 pb-32">
    <div class="container">
        <div class="w-full px-4">
            <div class="max-w-xl mx-auto text-center mb-16">
                <h4 class="font-semibold text-lg text-primary mb-2 sm:4xl lg:5xl">Contact</h4>
                <h2 class="font-bold text-dark text-3xl mb-4">Hubungi Kami</h2>
                <p class="font-medium text-md text-secondary md:text-lg">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quam, at.</p>
            </div>
        </div>
        ...
        <form action="">
            <div class="w-full lg:w-2/3 lg:mx-auto">
                <div class="w-full px-4 mb-8">
                    ...
                    <input type="text" name="name" id="name" class="w-full bg-slate-200 text-dark p-3 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary">
                </div>
                <div class="w-full px-4 mb-8">
                ...
                <div class="w-full px-4 mb-8">
                    ...
                    <textarea type="text" name="message" id="message" class="w-full bg-slate-200 text-dark p-3 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary h-32"></textarea>
                </div>
                <div class="w-full px-4">
                    <button class="text-base font-semibold text-white bg-primary py-3 px-8 rounded-full w-full hover:opacity-80 hover:shalolg
                    transition duration-500">Kirim</button>
                </div>
            </div>
        </form>
    </div>
